...
public class Player_1
{
    ...
    public Player_1()
    {
        ...
        Game.Player_Turn_Arrow.setLocation(((Game.Game_Width - Game.Card_Width) / 32) + (Game.Card_Width * 2) - 40, (Game.Game_Height - Game.Card_Height) - 180);
        
        Game.Cards.get(Cards_Challenge.i - 5).getCards_Holder().addMouseMotionListener(Player_1_Handler);
        Game.Cards.get(Cards_Challenge.i - 6).getCards_Holder().addMouseMotionListener(Player_1_Handler);
        Game.Cards.get(Cards_Challenge.i - 7).getCards_Holder().addMouseMotionListener(Player_1_Handler);
        Game.Cards.get(Cards_Challenge.i - 8).getCards_Holder().addMouseMotionListener(Player_1_Handler);
    }
    public void Delete_Mouse_Motion_Listener()
    {
        Game.Cards.get(Cards_Challenge.i - 5).getCards_Holder().removeMouseMotionListener(Player_1_Handler);
        Game.Cards.get(Cards_Challenge.i - 6).getCards_Holder().removeMouseMotionListener(Player_1_Handler);
        Game.Cards.get(Cards_Challenge.i - 7).getCards_Holder().removeMouseMotionListener(Player_1_Handler);
        Game.Cards.get(Cards_Challenge.i - 8).getCards_Holder().removeMouseMotionListener(Player_1_Handler);
    }
    ...
    public MouseMotionListener Player_1_Handler = new MouseMotionListener()
    {
        @Override
                        ...
                        P.getCards_Holder().getBounds().getY() + P.getCards_Holder().getBounds().height <= Game.Playing_Place.getY() + Game.Playing_Place.getHeight()))
                    {
                        ...
                        if(P.getCard_Value() == 11 || (P.getCard_Value() == 7 && P.getCard_Shape().equals(Playing_Cards.Shapes_Names.Diamond)))
                        {
                            ...
                            if(Table_Cards != 0)
                            {
                                ...
                                Cards_Challenge.Last_Player_To_Collect = 1;
                            }
                            else
                            {
                                ...
                                for(Playing_Cards S : Cards_Challenge.Cards_On_Table)
                                {
                                    for(Playing_Cards M : Cards_Challenge.Cards_On_Table)
                                    {
                                           ...
                                           S.getCard_Shape() != M.getCard_Shape())
                                        {
                                            ...
                                            Game.Player_1_Score = Game.Player_1_Score + 4;
                                ...
                                for(Playing_Cards Z : Cards_Challenge.Cards_On_Table)
                                {
                                    for(Playing_Cards S : Cards_Challenge.Cards_On_Table)
                                    {
                                        if(P.getCard_Value() == Z.getCard_Value() && P.getCard_Value() == S.getCard_Value() && Z.getCard_Shape() != S.getCard_Shape())
                                        {
                                            ...
                                            Game.Player_1_Score = Game.Player_1_Score + 3;
                            ...
                            if(Card_Found == false)
                            {
                                for(Playing_Cards Z : Cards_Challenge.Cards_On_Table)
                                {
                                    if(P.getCard_Value() == Z.getCard_Value() && P.getCard_Shape() != Z.getCard_Shape())
                                    {
                                        ...
                                        Game.Player_1_Score = Game.Player_1_Score + 2;
